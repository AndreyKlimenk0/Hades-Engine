...
void World::init(Free_Camera *camera)
{
	...
	sphere->model->set_model_color(Blue);
	...
	box->model->set_model_color(Blue);
	...
	sphere3->model->set_model_color(Blue);
	...
	l->model->set_model_color(Vector3(1.0f, 1.0f, 1.0f));
...
void World::draw()
{
	...
	draw_entities(&entity_manager, view, free_camera);
